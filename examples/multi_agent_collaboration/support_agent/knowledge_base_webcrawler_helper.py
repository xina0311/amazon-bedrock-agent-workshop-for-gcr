...
class WebCrawlerKnowledgeBasesForAmazonBedrock:
    """
    ...
    def create_or_retrieve_webcrawler_knowledge_base(
        self,
        kb_name: str,
        ...
        """
        Function used to create a new Knowledge Base using WebCrawler as data source or retrieve an existent one
        ...
        if kb_id is not None:
            ...
            print("========================================================================================")
            print(f"Step 5 - Creating Knowledge Base with Web Crawler Data Source")
            
            # Create Knowledge Base with Web Crawler configuration
    ...
    def create_bedrock_kb_execution_role(
        ...
        """
        Creates IAM role and policies needed for a Knowledge Base with Web Crawler data source
        
        Args:
            role_name: Name of the IAM role to create
            embedding_model: Name of the embedding model to be used
            secret_arn: ARN of the secret containing Web Crawler credentials
        ...
        try:
            ...
            try:
                role = self.iam_client.create_role(
                    ...
                    Description="IAM role for Amazon Bedrock Knowledge Base with Web Crawler integration"
                )
    ...
    def create_knowledge_base(
        ...
        try:
            create_ds_response = self.bedrock_agent_client.create_data_source(
                ...
                description=f"Web Crawler data source for {kb_name}",
